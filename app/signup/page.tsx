            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2 pt-2">
                ...
                >
                  ...
                  <Link
                    href="/terms"
                    className="text-primary hover:text-orange-600 hover:underline"
                  >
                    Terms of Service
                  </Link>{" "}
                  and{" "}
              ...
              <Button
                type="submit"
                className="w-full gradient-primary text-white hover:shadow-lg hover:shadow-orange-500/25 transition-all duration-300 h-11 mt-2"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
